...
while t <= 2+h
    %Ground Excitation and the Respective Derivative on each Subsystem at Time Instance t-2h
    ...
    %Excitation Force on each Subsystem at Time Instance t-2h
    F_1 = zeros(70,1); 
    F_1(67) = cw*R1d_1 + kw*R1_1;
    F_1(68) = cw*R2d_1 + kw*R2_1;
    F_1(69) = cw*R3d_1 + kw*R3_1;
    F_1(70) = cw*R4d_1 + kw*R4_1;
    %Ground Excitation and the Respective Derivative on each Subsystem at Time Instance t-h
    ...
    %Excitation Force on each Subsystem at Time Instance t-h
    F_2 = zeros(70,1);
