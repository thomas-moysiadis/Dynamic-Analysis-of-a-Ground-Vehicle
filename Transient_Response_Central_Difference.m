...
R1_0 = r01*cos(2*pi*W1*0); %Ground Excitation on the First Subsystem at Time Instance 0
R1d_0 = -2*pi*W1*r01*sin(2*pi*W1*0); %Derivative of the Ground Excitation on the First Subsystem at Time Instance 0
R2_0 = r02*sin(2*pi*W2*0); %Ground Excitation on the Second Subsystem at Time Instance 0
R2d_0 = 2*pi*W2*r02*cos(2*pi*W2*0); %Derivative of the Ground Excitation on the Second Subsystem at Time Instance 0
R3_0 = r03*sin(2*pi*W3*0); %Ground Excitation on the Third Subsystem at Time Instance 0
R3d_0 = 2*pi*W3*r03*cos(2*pi*W3*0); %Derivative of the Ground Excitation on the Third Subsystem at Time Instance 0
R4_0 = r04*cos(2*pi*W4*0); %Ground Excitation on the Fourth Subsystem at Time Instance 0
R4d_0 = -2*pi*W4*r04*sin(2*pi*W4*0); %Derivative of the Ground Excitation on the Fourth Subsystem at Time Instance 0
F_0 = zeros(70,1); %Force Vector at Time Instance 0
F_0(67) = cw*R1d_0 + kw*R1_0; %Excitation Force on the First Subsystem at Time Instance 0
F_0(68) = cw*R2d_0 + kw*R2_0; %Excitation Force on the Second Subsystem at Time Instance 0
F_0(69) = cw*R3d_0 + kw*R3_0; %Excitation Force on the Third Subsystem at Time Instance 0
F_0(70) = cw*R4d_0 + kw*R4_0; %Excitation Force on the Fourth Subsystem at Time Instance 0
a(1,:) = (inv(M)*(F_0 - C*v(1,:)' - K*u(2,:)'))'; %Acceleration at Time Instance 0
u(1,:) = 1/2*(h^2*a(1,:) - 2*h*v(1,:) + 2*u(2,:)); %Displacement at Time Instance -1
t = h;
A = inv(M/h^2 + C/2/h + K/3); %Compute Stable Matrix A for Displacement Calculation at each Time Instance t
while t <= 2+h
    R1_1 = r01*cos(2*pi*W1*(t-2*h)); %Ground Excitation on the First Subsystem at Time Instance t-2*h
    R1d_1 = -2*pi*W1*r01*sin(2*pi*W1*(t-2*h)); %Derivative of the Ground Excitation on the First Subsystem at Time Instance t-2*h 
    R2_1 = r02*sin(2*pi*W2*(t-2*h)); %Ground Excitation on the Second Subsystem at Time Instance t-2*h
    R2d_1 = 2*pi*W2*r02*cos(2*pi*W2*(t-2*h)); %Derivative of the Ground Excitation on the Second Subsystem at Time Instance t-2*h 
    R3_1 = r03*sin(2*pi*W3*(t-2*h)); %Ground Excitation on the Third Subsystem at Time Instance t-2*h 
    R3d_1 = 2*pi*W3*r03*cos(2*pi*W3*(t-2*h)); %Derivative of the Ground Excitation on the Third Subsystem at Time Instance t-2*h
    R4_1 = r04*cos(2*pi*W4*(t-2*h)); %Ground Excitation on the Fourth Subsystem at Time Instance t-2*h
    R4d_1 = -2*pi*W4*r04*sin(2*pi*W4*(t-2*h)); %Derivative of the Ground Excitation on the Fourth Subsystem at Time Instance t-2*h 
    F_1 = zeros(70,1); %Force Vector at Time Instance t-2*h 
    F_1(67) = cw*R1d_1 + kw*R1_1; %Excitation Force on the First Subsystem at Time Instance t-2*h
    F_1(68) = cw*R2d_1 + kw*R2_1; %Excitation Force on the Second Subsystem at Time Instance t-2*h
    F_1(69) = cw*R3d_1 + kw*R3_1; %Excitation Force on the Third Subsystem at Time Instance t-2*h
    F_1(70) = cw*R4d_1 + kw*R4_1; %Excitation Force on the Fourth Subsystem at Time Instance t-2*h
    R1_2 = r01*cos(2*pi*W1*(t-h)); %Ground Excitation on the First Subsystem at Time Instance t-h
    R1d_2 = -2*pi*W1*r01*sin(2*pi*W1*(t-h)); %Derivative Excitation on the First Subsystem at Time Instance t-h
    R2_2 = r02*sin(2*pi*W2*(t-h)); %Ground Excitation on the Second Subsystem at Time Instance t-h
    R2d_2 = 2*pi*W2*r02*cos(2*pi*W2*(t-h)); %Derivative of the Ground Excitation on the Second Subsystem at Time Instance t-h
    R3_2 = r03*sin(2*pi*W3*(t-h)); %Ground Excitation on the Third Subsystem at Time Instance t-h
    R3d_2 = 2*pi*W3*r03*cos(2*pi*W3*(t-h)); %Derivative of the Ground Excitation on the Third Subsystem at Time Instance t-h
    R4_2 = r04*cos(2*pi*W4*(t-h)); %Ground Excitation on the Fourth Subsystem at Time Instance t-h
    R4d_2 = -2*pi*W4*r04*sin(2*pi*W4*(t-h)); %Derivative of the Ground Excitation on the Fourth Subsystem at Time Instance t-h
    F_2 = zeros(70,1); %Force Vector at Time Instance t-h
    F_2(67) = cw*R1d_2 + kw*R1_2; %Excitation Force on the First Subsystem at Time Instance t-h
    F_2(68) = cw*R2d_2 + kw*R2_2; %Excitation Force on the Second Subsystem at Time Instance t-h
    F_2(69) = cw*R3d_2 + kw*R3_2; %Excitation Force on the Third Subsystem at Time Instance t-h
    F_2(70) = cw*R4d_2 + kw*R4_2; %Excitation Force on the Fourth Subsystem at Time Instance t-h
    R1_3 = r01*cos(2*pi*W1*t); %Ground Excitation on the First Subsystem at Time Instance t
    R1d_3 = -2*pi*W1*r01*sin(2*pi*W1*t); %Derivative of the Ground Excitation on the First Subsystem at Time Instance t
    R2_3 = r02*sin(2*pi*W2*t); %Ground Excitation on the Second Subsystem at Time Instance t
    R2d_3 = 2*pi*W2*r02*cos(2*pi*W2*t); %Derivative of the Ground Excitation on the Second Subsystem at Time Instance t
    R3_3 = r03*sin(2*pi*W3*t); %Ground Excitation on the Third Subsystem at Time Instance t
    R3d_3 = 2*pi*W3*r03*cos(2*pi*W3*t); %Derivative of the Ground Excitation on the Third Subsystem at Time Instance t
    R4_3 = r04*cos(2*pi*W4*t); %Ground Excitation on the Fourth Subsystem at Time Instance t
    R4d_3 = -2*pi*W4*r04*sin(2*pi*W4*t); %Derivative of the Ground Excitation on the Fourth Subsystem at Time Instance t
    F_3 = zeros(70,1); %Force Vector at Time Instance t
    F_3(67) = cw*R1d_3 + kw*R1_3; %Excitation Force on the First Subsystem at Time Instance t
    F_3(68) = cw*R2d_3 + kw*R2_3; %Excitation Force on the Second Subsystem at Time Instance t
    F_3(69) = cw*R3d_3 + kw*R3_3; %Excitation Force on the Third Subsystem at Time Instance t
    F_3(70) = cw*R4d_3 + kw*R4_3; %Excitation Force on the Fourth Subsystem at Time Instance t

    u(round(t/h)+2,:) = (A*(1/3*(F_3+F_2+F_1) + (2*M/h^2-K/3)*u(round(t/h)+1,:)' + (-M/h^2+C/2/h-K/3)*u(round(t/h),:)'))'; %Displacement at each Time Instance t

    if t/h >= 2
        v(round(t/h),:) = 1/2/h*(u(round(t/h)+2,:) - u(round(t/h),:)); %Velocity at each Time Instance t
        a(round(t/h),:) = 1/h^2*(u(round(t/h)+2,:) - 2*u(round(t/h)+1,:) + u(round(t/h),:)); %Acceleration at each Time Instance t
    end
